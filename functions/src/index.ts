...
async function revertModificationsOutsideForm(document: FirebaseFirestore.DocumentData, beforeDocument: FirebaseFirestore.DocumentData | null | undefined, snapshot: FirebaseFirestore.DocumentSnapshot) {
...
function validateForm(entity: Entity, document: DocumentData) {
...
function getFormModifiedFields(document: DocumentData) {
...
async function delayFormSubmissionAndCheckIfCancelled(delay: number, snapshot: firestore.DocumentSnapshot) {
...
async function runBusinessLogics(actionType: ActionType, formModifiedFields: string[], entity: Entity, action: Action) {
...
function groupDocsByUserAndDstPath(logicResults: Awaited<LogicResult>[], userId: string) {
