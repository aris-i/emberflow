...
describe("onFormSubmit", () => {
  ...
  it("should execute the sequence of operations correctly", async () => {
    ...
    console.debug("debug 1", expandConsolidateAndGroupByDstPathMock.mock.calls[0]);
    console.debug("debug 2", expandConsolidateAndGroupByDstPathMock.mock.calls[1]);
    console.debug("debug 3", expandConsolidateAndGroupByDstPathMock.mock.calls[2]);
    console.debug("debug 4", expandConsolidateAndGroupByDstPathMock.mock.calls[3]);
    ...
    expect(indexutils.distributeLater).toHaveBeenNthCalledWith(1, normalPriorityOtherDocsByDocPath, "1.0.0",);
    ...
    expect(indexutils.distributeLater).toHaveBeenNthCalledWith(2, lowPriorityDocsByDocPath, "1.0.0",);
    expect(indexutils.distributeLater).toHaveBeenNthCalledWith(3, lowPriorityOtherDocsByDocPath, "1.0.0",);
